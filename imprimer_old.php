...
$pdf->Cell(95, 7, 'Date de presentation : 16/05/2024', 0, 1);
$pdf->Cell(95, 7, 'Reference Client : 10538765', 0, 0);
$pdf->Cell(95, 7, 'Date limite paiement : 25/05/2024', 0, 1);
$pdf->Cell(95, 7, 'Adresse installation : Tanambao', 0, 1);
$pdf->Cell(95, 7, 'Numero compteur electricite : C096567889', 0, 1);
$pdf->Cell(95, 7, 'Numero compteur eau : E09976585', 0, 1);
$pdf->Ln(5);

// Tableau Facture
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(63, 7, ' ', 1, 0, 'C');
$pdf->Cell(63, 7, 'Electricite', 1, 0, 'C');
